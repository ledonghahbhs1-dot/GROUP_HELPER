...
def get_features_info_text() -> str:
    ...
    return (
        f"🔥 <b>WOLFMOD VIP SCRIPT V9.0 - DRAGON CITY</b> 🔥\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"{emoji_mgr.vip} <b>VIP FEATURE DETAILED LIST</b> {emoji_mgr.vip}\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        f"🛠 <b>1. APP & MEMORY TOOLS:</b>\n"
        f"• <b>Revert & Unfreeze Values:</b> Restore original values & unfreeze memory\n"
        f"• <b>Set Memory Ranges:</b> Configure C_ALLOC + ANONYMOUS ranges\n"
        f"• <b>Anti Reset Game (Basic):</b> Basic anti-reset / anti-crash protection\n"
        f"• <b>Hide GameGuardian Icon:</b> Hide GameGuardian floating icon\n"
        f"• <b>Force Close Game:</b> Immediately force close game\n"
        f"• <b>Instructions:</b> Detailed usage guide\n\n"
        f"🗡️ <b>2. BATTLE MODS:</b>\n"
        f"• <b>Easy Arena Battle:</b> Auto Win / Auto Lose instantly\n"
        f"• <b>Easy Leagues Battle:</b> Auto Win / Auto Lose instantly\n"
        f"• <b>Easy Rescue Battle:</b> Auto Win / Auto Lose instantly\n"
        f"• <b>Easy Quest Battle:</b> Auto Win / Auto Lose instantly\n"
        f"• <b>Farm Orb:</b> In-battle fixed Orb farming trick\n"
        f"• <b>Combat / Battle Stats:</b> View Rank, Damage & Health stats for dragons\n\n"
        f"🐉 <b>3. DRAGON MODS:</b>\n"
        f"• <b>Hack Max Stats:</b> Max Level, Max Health (God Mode), Max Damage (One-Hit Kill), Max Rank, Max 5 Stars\n"
        f"• <b>Clone Dragon:</b> Copy appearance & skills to 1 dragon or all dragons\n"
        f"• <b>Bypass Busy Status:</b> Use dragons while busy (hatching, breeding, training)\n\n"
        f"🌳 <b>4. TREE OF LIFE MODS:</b>\n"
        f"• <b>No-Sample Trade:</b> Trade Orbs without owning sample Orbs\n"
        f"• <b>No-Duplicate Recall:</b> Recall dragons for Orbs without duplicate copies\n\n"
        f"🔱 <b>5. SKILL HACKS:</b>\n"
        f"• <b>Bypass Verified Attack Skills:</b> Bypass server-side attack skill verification\n"
        f"• <b>Train Skill Attack Early:</b> Train skills early at Training Center (No Lv15 required)\n\n"
        f"⏱️ <b>6. TIME & SPEED:</b>\n"
        f"• <b>Speed Hack Animation:</b> Custom animation & game motion speed hack\n"
        f"• <b>Skip Time Hatch & Breed:</b> Skip hatching & breeding countdown timers instantly\n\n"
        f"🎪 <b>7. EVENT MODS & ISLANDS:</b>\n"
        f"• <b>Skip Event Battle Time:</b> Skip Heroic Race battle cooldown timers instantly\n"
        f"• <b>Events Data & Analyzer:</b> View Lap/Node data & event reward details\n"
        f"• <b>Move Habitat & Buildings:</b> Move habitats & buildings freely without limits\n\n"
        f"📦 <b>8. EXTRA TOOLS:</b>\n"
        f"• <b>Complete Item Index:</b> Display complete item index list (<code>tid_</code>)\n"
        f"• <b>Predict Dragon Collection:</b> Predict dragon collection rewards\n"
        f"• <b>Offline Mode:</b> Unlock resources, speed up Food\n"
        f"• <b>Private DNS AdBlocker:</b> Block in-game ads using private DNS\n"
        f"• <b>Admin Privileges / Commands:</b> Admin commands & quick game restart\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"{emoji_mgr.star} <b>DRAGON CITY FREE SCRIPT FEATURES:</b>\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"• <b>App & GG Tools:</b> Basic configuration\n"
        f"• <b>Easy Arena Battle:</b> Auto Win / Auto Lose\n"
        f"• <b>Easy Rescue Battle:</b> Auto Win / Auto Lose\n"
        ...
        f"• <b>Facebook:</b> <a href=\"https://fb.com/wolfmodkk\">fb.com/wolfmodkk</a>\n"
        f"• <b>Telegram Admin:</b> {emoji_mgr.vip} :@wolfmodyt {emoji_mgr.vip}"
    )
